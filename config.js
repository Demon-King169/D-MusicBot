module.exports = {
	...
	website: "https://d-music-38f3e09078a5.herokuapp.com", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "Main Node", //- Used for indentifier in stats commands.
			host: "51.81.166.66", //- The host name or IP of the lavalink server.
			port: 30608, // The port that lavalink is listening to. This must be a number!
			password: "d-music", //- The password of the lavalink server.
